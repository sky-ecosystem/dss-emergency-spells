...
`cli/emergency-spells` drafts and validates deployment records, verifies deployed contracts, prepares and verifies batches, inspects deployed batch contents, and probes registry-global execution failures. Run it from the repository root.
...
cli/emergency-spells probe-registry \
...
```text
Registry probe at block 12345678
