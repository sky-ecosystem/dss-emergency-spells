...
contract StUsdsLineWipeSpell is DssEmergencySpell {
    ...
    function description() external pure returns (string memory) {
        return string(abi.encodePacked("Emergency Spell | Line Wipe: stUSDS"));
    }
     ...
     * @dev Checks if the line has been wiped from stUSDS and if the max line has been wiped from the rate setter.
