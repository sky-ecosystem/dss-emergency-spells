...
contract GlobalOsmStopSpellV2IntegrationTest is DssTest {
    ...
    function testGlobalOsmStopV2OnMainnet() public {
        GlobalOsmStopSpellV2 spell =
            new GlobalOsmStopSpellV2(dss.chainlog.getAddress("ILK_REGISTRY"), dss.chainlog.getAddress("OSM_MOM"));
