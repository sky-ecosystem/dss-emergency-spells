...
contract EmergencySpellBatchFactoryV2Test is Test {
    ...
    function testPermissionlessCreateDeployment() public {
        ...
        emit BatchDeployed(address(0), configHash);
        vm.prank(caller);
    ...
    function testDeployAcceptsAnyUniqueSequenceAndCanRepeat() public {
        ...
        assertEq(EmergencySpellBatchV2(first).configHash(), EmergencySpellBatchV2(second).configHash());
    }

    function testDeployRejectsDuplicateLeaves() public {
        ...
        factory.deploy(duplicates, "Duplicate");
    }
}
