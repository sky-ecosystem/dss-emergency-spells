...
jq '.records[0].subjects["ilk()(bytes32)"] = "0x575442432d410000000000000000000000000000000000000000000000000000"' \
    "$root/test/scripts/fixtures/v2-manifest-valid.json" > "$tmpdir/mismatched-subject.json"
